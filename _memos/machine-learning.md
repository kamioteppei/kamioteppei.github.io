...
それに対して、縦横(HxW)5x5のフィルタを、1づつスライドさせると、
縦横(HxW)が30x30の畳み込み画像ができる。フィルターは、5x5の重みの行列になっており、そのフィルターの数だけ、
畳み込みデータが作成される。フィルターの重み(画像の個々の特徴)は自動で抽出される。  
...
[参照](https://qiita.com/KojiOhki/items/89cd7b69a8a6239d67ca)
